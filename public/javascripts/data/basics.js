let data = [
  ...
  },
  {
    ...
    description: [],
    img: 'stalemate.png',
    positions: ['7k/8/6KP/8/8/8/8/8 w - - 0 1', '2k5/2B5/2K5/8/2N5/8/8/8 w - - 0 1'],
  },
  {
    title: 'Castle',
...
let chapters = [
  ...
  },
  {
    name: 'Checkmate',
    method: function () {
      positionHandler.validator = function (chess) {
  ...
  },
  {
    name: 'Castle',
    method: function () {
      positionHandler.validator = function (chess, move) {
        return move.flags === 'k' || move.flags === 'q';
      };
      chessGame.setHandler(positionHandler);
      chessGame.setMode(gameMode);
    },
